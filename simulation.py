...
class Simulation(object):
    ...
    def sim_getsamples(Vedges,rho,Nsamples):
        ...
        return output  
    '''      
    def update(self,t0 = 0.0,dt = 1e-1,tf = 1024.0):
        self.dt = dt
        self.tf = tf   
        # initialize:
...
#                            print('Lag-parame: ',p.La0)
        ...
        return self.mEbin_ra,self.mIbin_ra,self.xEbin_ra,self.xIbin_ra,self.VEavg_ra,self.VIavg_ra,self.VEstd_ra,self.VIstd_ra,self.rEbin_ra,self.rIbin_ra,self.P_MFEbin_ra